...
class DetailPage extends StatefulWidget {
  ...
  DetailPage({required this.newCocktail});
...
// Function to retrieve the user's favorite cocktails from Firestore
  ...
  Widget build(BuildContext context){
    ...
    List<String> instructionPoints =
        separateInstructions(widget.newCocktail.strInstructions);
    return Scaffold(
      appBar: AppBar(
            ...
            builder: (context, snapshot) {
              if (snapshot.connectionState == ConnectionState.waiting) {
                ...
                if (isFavorite!) {
                  ...
                  return IconButton(
                    onPressed: () {
                      saveFavoriteCocktail(widget.newCocktail).then((value) {
                        setState(() {
                          isDataSet=true;
                        });
                      });
                    },
                    icon: isDataSet? Icon(Icons.favorite_rounded, color: Colors.red,)  : Icon(Icons.favorite_outline_rounded), // Show empty heart icon
                  );
                }
              }
          ...
          children: <Widget>[
            ...
            Padding(
              ...
              child: Column(
                ...
                children: <Widget>[
                  Text(
                    widget.newCocktail.strCategory,
                    style: TextStyle(
                      fontSize: 24,
                  ...
                  Row(
                    children: [
                      ...
                      SizedBox(width: 8),
                      Text(
                        widget.newCocktail.strAlcoholic,
                        style: TextStyle(
                          fontSize: 18,
                          fontWeight: FontWeight.bold,
                        ),
                  ...
                  SizedBox(height: 16),
                  if (widget.newCocktail.ingredients
                      ...
                      children: <Widget>[
                        ...
                        Container(
                          ...
                          child: ListView.builder(
                            ...
                            itemCount: widget.newCocktail.ingredients.length,
                            itemBuilder: (context, index) {
                              final ingredient =
                                  widget.newCocktail.ingredients[index];
                              final measure =
                                  widget.newCocktail.measures[index];
                  ...
                  if (instructionPoints.isNotEmpty)
                    Column(
                      ...
                      children: instructionPoints.asMap().entries.map((entry) {
                        final index =
                            entry.key + 1; // Get the instruction number
